...
public class CLagUtils {
	...
	public static Object private_get(Object o, String name) {
		return private_get(o, name, null);
	}

	public static int private_get_int(Object o, String name) {
		return (Integer) private_get(o, name, (Integer) 0);
	}

	public static void private_set_int(Object o, String name, int v) {
		private_set(o, name, (Integer) v);
	}

	public static boolean private_get_bool(Object o, String name) {
		return (Boolean) private_get(o, name, (Boolean) false);
	}

	public static void private_set_bool(Object o, String name, boolean v) {
		private_set(o, name, (Boolean) v);
	}
